...
public class VideoPlaySwift extends Activity {
...
//		});
	...
	private void playVideo() {
		try {
			...
			String uri = "android.resource://" + getPackageName() + "/"+R.raw.swift;
			Log.v(TAG, "path: " + path);
			if (path == null || path.length() == 0) {
				Toast.makeText(VideoPlaySwift.this, "File URL/path is empty",
