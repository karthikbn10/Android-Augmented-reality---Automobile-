...
public class VideoPlayAlto extends Activity {
...
//		});
	...
	private void playVideo() {
		try {
			...
			String uri = "android.resource://" + getPackageName() + "/"+R.raw.altok10;
			Log.v(TAG, "path: " + path);
			if (path == null || path.length() == 0) {
				Toast.makeText(VideoPlayAlto.this, "File URL/path is empty",
