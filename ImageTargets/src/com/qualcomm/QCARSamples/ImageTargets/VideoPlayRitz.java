...
public class VideoPlayRitz extends Activity {
...
//		});
	...
	private void playVideo() {
		try {
			...
			String uri = "android.resource://" + getPackageName() + "/"+R.raw.ritz;
			Log.v(TAG, "path: " + path);
			if (path == null || path.length() == 0) {
				Toast.makeText(VideoPlayRitz.this, "File URL/path is empty",
