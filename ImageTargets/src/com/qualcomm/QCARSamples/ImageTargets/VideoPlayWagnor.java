...
public class VideoPlayWagnor extends Activity {
...
//		});
	...
	private void playVideo() {
		try {
			final String path = "/sdcard/DCIM/getmovie.mp4";
			
			String uri = "android.resource://" + getPackageName() + "/"+R.raw.wagonr;
			Log.v(TAG, "path: " + path);
			if (path == null || path.length() == 0) {
				Toast.makeText(VideoPlayWagnor.this, "File URL/path is empty",
